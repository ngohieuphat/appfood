...
import 'package:flutter_appsa/common/widget/progress_listener_widget.dart';
import 'package:flutter_appsa/data/repositories/authentication_repository.dart';
import 'package:flutter_appsa/presentations/features/sign_up/sign_up_bloc.dart';
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ...
                if (name.isNotEmpty &&
                  ...
                  ScaffoldMessenger.of(context)
                      .showSnackBar(SnackBar(content: Text("Input empty")));
                  return;
                }
              },
            )));
